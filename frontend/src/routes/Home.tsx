    ...
    return (
        <>
            <div className="min-w-screen max-h-screen flex justify-center">
                <img src="/public/gradient-purple-2.png" className="absolute select-none right-0" draggable={false} alt="" />
                <img src="/public/gradient-orange.png" className="absolute left-0 select-none" draggable={false} alt="" />
